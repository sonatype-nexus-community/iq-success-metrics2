...
public class SQLStatement {
	...
	public static String MTTR = "select TIME_PERIOD_START, isnull(sum(MTTR_CRITICAL_THREAT)/(60*60*24*1000),0) as countA, isnull(sum(MTTR_SEVERE_THREAT)/(60*60*24*1000),0) as countB, isnull(sum(MTTR_MODERATE_THREAT)/(60*60*24*1000),0) as countC from metric group by TIME_PERIOD_START";
}
