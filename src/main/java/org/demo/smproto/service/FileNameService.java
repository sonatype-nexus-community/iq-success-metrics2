...
//	private String csvDirectory;
	...
	// String csvPolicyViolationsFilePath;
	
	private static final Logger log = LoggerFactory.getLogger(FileNameService.class);
	
	public String getCSVFile(String metricType) {
